...
export const CameraOn = (props: IconProps) => (
  <svg
    width={24}
    height={24}
    viewBox="0 0 24 24"
    ...
    <defs>
      ...
      >
        ...
        <feComposite
          in2="SourceAlpha"
          operator="in"
          result="effect1_backgroundBlur_700_2325"
        />
        <feBlend
          in="SourceGraphic"
          in2="effect1_backgroundBlur_700_2325"
          result="shape"
        />
        <feColorMatrix
          in="SourceAlpha"
        ...
        <feBlend in2="shape" result="effect2_innerShadow_700_2325" />
      </filter>
      <filter
        id="c"
        x={-16}
